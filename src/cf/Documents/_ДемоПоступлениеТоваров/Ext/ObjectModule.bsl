...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	СформироватьДвиженияПоКонтактамПартнера();
...
Процедура СформироватьДвиженияПоКонтактамПартнера()
	КонтактнаяИнформация = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(Партнер);	
КонецПроцедуры
